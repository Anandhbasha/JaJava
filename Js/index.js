...
// Async
// Promise
// promisename = new Promise((resolved,reject)=>{

// // })
// let speak = new Promise((resolved,reject)=>{
//   let spoken = true
//   if(spoken==true){
//     resolved("They are speaking");
//   }
//   else{
//     reject("They are not speaking");
//   }
// })
// speak.then((result)=>console.log(result)).catch((error)=>console.log(error))

// const fetchData = new Promise((resolved,rejected)=>{
//   //get 
//   fetch("https://fakestoreapi.com/products").then((res)=>{
//     if(res.ok){
//       resolved(res.json())
//     }else{
//       rejected("Error in fetching data")
//     }
//   })
//   //post
//   //put
